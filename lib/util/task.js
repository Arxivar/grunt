...
// Expose task success callback
var successCallback = function(){};
exports.successCallback = successCallback;
// Expose done queue callback
var doneQueueCallback = function(){};
exports.doneQueueCallback = doneQueueCallback;
  ...
  Task.prototype.registerTask = function(name, info, fn) {
    ...
    // Add task into cache.
    this._tasks[name] = {name: name, info: info, fn: fn, tasks: tasks};
    // Make chainable!
    return this;
  };
  ...
  Task.prototype.runTaskFn = function(context, fn, done, asyncDone) {
    ...
    var complete = function(success) {
	  ...
	  if(exports.successCallback && success === true)
	 	 exports.successCallback({name: context.name, nameArgs: context.nameArgs, type: 'task'});
      ...
      if (!success && this._options.error) {
        this._options.error.call({name: context.name, nameArgs: context.nameArgs, type: 'task'}, err);
	  }
    ...
    var nextTask = function() {
      ...
      if (!thing) {
        ...
        if (this._options.done) {
			if(exports.doneQueueCallback)
				exports.doneQueueCallback();
          this._options.done();
        }
        return;
      }
