...
grunt['utilTask'] = require('./util/task');
...
gExpose(task, 'getAllTasks');
gExpose(config, 'init', 'initConfig');
gExpose(fail, 'warn');
gExpose(fail, 'fatal');
gExpose(fail, 'onFatalError');
gExpose(grunt['utilTask'],'successCallback');
...
grunt.tasks = function(tasks, options, done) {
  ...
  task.options({
    error: function(e) {
      fail.warn({name: task.name, nameArgs: task.nameArgs, type: 'task', message: e}, fail.code.TASK_FAILURE);
    },
    done: function() {
